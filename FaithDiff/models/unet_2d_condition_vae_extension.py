...
class UNet2DConditionModel(OriginalUNet2DConditionModel, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    ...
    def __init__(
        ...
        self.information_transformer_layers = None
    ...
    def to(self, *args, **kwargs):
        ...
        for module in [self.denoise_encoder, self.information_transformer_layers,
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        for module_name, module_dict in additional_dicts.items():
            ...
            if module is not None and module_dict:
                ...
                print("successfully loaded state dict for module {}".format(module_name))
    ...
    def forward(
        ...
        if input_embedding is not None and self.condition_embedding is not None and self.information_transformer_layers is not None:
