...
class LLavaAgent:
    def __init__(self, model_path, device='cuda', conv_mode='vicuna_v1', load_8bit=False, load_4bit=True):
        ...
        self.qs = 'Describe this image in a very detailed manner.'
...
if __name__ == '__main__':
    llava_agent = LLavaAgent("/data2/cjy/FaithDiff/llava_v1.5-13b/models--liuhaotian--llava-v1.5-13b/snapshots/llava",
                             device='cuda', load_8bit=True, load_4bit=False)
    img = [Image.open('/data2/cjy/RealDeg/real_scene_data/Old_photo_resize/0.jpg'),
           Image.open('/data2/cjy/RealDeg/real_scene_data/Old_photo_resize/0.jpg')]
