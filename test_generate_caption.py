...
with torch.no_grad():
    for file_name in sorted(os.listdir(args.img_dir)):
        ...
        file_path = os.path.join(args.save_dir, json_name)
        if os.path.exists(file_path):
            cnt += 1
            print(f"JSON for {file_name} already exists. Skipping. {cnt}")
        ...
        # if args.type == "rain":
        #     degradation_description = "This is a rainy image"
        # elif args.type == "haze":
        #     degradation_description = "This is a hazy image"
        # elif args.type == "blur":
        #     degradation_description = "This is a blurry image"
        # elif args.type == "noise":
        #     degradation_description = "This is a noisy image"
        # elif args.type == "low-light":
        #     degradation_description = "This is a low-light image"
        #
        # full_caption = f"{degradation_description}. {captions[0]}"
