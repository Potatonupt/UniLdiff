...
def check_image_size(x, padder_size=8):
    ...
    if width % padder_size == 0 and height % padder_size == 0:
        return x, width, height, width, height
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_in_path', type=str, default='/data/czh/data/test/SOTS/GT')
    parser.add_argument('--test_gt_path', type=str, default='/data/czh/code/faithdiff/save/epoch40000/SOTS')
    parser.add_argument('--model_path', type=str, default='/data/czh/code/faithdiff/nafmodel/epoch_400.pth')
    parser.add_argument('--save_path', type=str, default='/data/czh/code/faithdiff/save/nafnet/SOTS')
