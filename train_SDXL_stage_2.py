...
def log_validation(unet, args, accelerator, weight_dtype, step):
    ...
    for file_name in test_img_list:
        ...
        gen_image = pipe(lr_img=lr_image, prompt=prompt_init, negative_prompt=negative_prompt_init,
                         num_images_per_prompt=num_samples, num_inference_steps=20, start_point='noise',
                         generator=generator, height=1024, width=1024).images[0]
...
def main():
    ...
    optimizer_grouped_parameters = [
        {'params': denoise_encoder_params_to_opt, 'lr': args.vis_learning_rate, 'weight_decay': args.adam_weight_decay,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            logs = {"noise_step_loss": diffusion_loss.detach().item(), "lr_vis": lr_scheduler.get_last_lr()[0],
                    "lr_unet": lr_scheduler.get_last_lr()[1]}
